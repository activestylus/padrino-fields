...
Forms made easy (for Padrino)!

Takes the pain out of building forms. Generates inputs, labels and field hints with a minimal and flexible DSL. Inspired by SimpleForm and Formtastic.
