...
require 'dm-core'
DataMapper::Model.append_extensions(Padrino::Helpers::FormBuilder::Orm::Datamapper::ClassMethods)
#DataMapper::Model.append_inclusions(Padrino::Helpers::FormBuilder::Orm::Datamapper::InstanceMethods) 